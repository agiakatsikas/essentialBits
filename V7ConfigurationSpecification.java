...
import edu.byu.ece.rapidSmith.bitstreamTools.configurationSpecification.*;

public class V7ConfigurationSpecification extends V7MaskConfigurationSpecification {

    public V7ConfigurationSpecification() {
        super();
        ...
        _bitstreamGenerator = V7BitstreamGenerator.getSharedInstance();
    }
