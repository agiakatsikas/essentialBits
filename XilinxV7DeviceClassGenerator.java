 ...
 */
public class XilinxV7DeviceClassGenerator extends XilinxDeviceClassGeneratorNew {
     ...
     */
    public XilinxV7DeviceClassGenerator(){
        super("artix7", V7MaskConfigurationSpecification.V7_ROW_MASK, V7MaskConfigurationSpecification.V7_ROW_BIT_POS, V7MaskConfigurationSpecification.V7_TOP_BOTTOM_MASK, V7MaskConfigurationSpecification.V7_TOP_BOTTOM_BIT_POS);
    }
    ...
    public void createJavaSourceFile() {
        ...
        try {
            ...
            buf.write("package unsw.cse.rsg.essentialBits.configurationSpecification;\n\n");
        ...
        for (String partName : _partNames) {
            ...
            try {
                ...
                while(line != null){
                    ...
                    if(tokens.length > 1 && tokens[1].equals("(tile")){
                        ...
                        if (name.equals("LIOI") || name.equals("RIOI")) {
                            ...
                            columnMap.put(column, V7ConfigurationSpecification.CLB);
                        }
                        else if (name.equals("DSP")) {
                            columnMap.put(column, V7ConfigurationSpecification.DSP);
                        }
                        else if (name.equals("CMT_TOP")) {
                            columnMap.put(column, V7ConfigurationSpecification.CLK);
                        }
                        else if (name.equals("GTX") || name.equals("GTH_L_TOP") || name.equals("GTH_L_BOT")) {
                            columnMap.put(column, V7ConfigurationSpecification.GTX);
                        }
                        else if (name.equals("BRAM")) {
                            columnMap.put(column, V7ConfigurationSpecification.BRAMINTERCONNECT);
                        }
                ...
                for (Integer key : columnMap.keySet()) {
                    ...
                    if (subType == V7ConfigurationSpecification.BRAMINTERCONNECT) {
                        currBramContentLayout.add(V7ConfigurationSpecification.BRAMCONTENT);
                    }
                }                
                
                currLogicLayout.add(V7ConfigurationSpecification.LOGIC_OVERHEAD);
                currBramContentLayout.add(V7ConfigurationSpecification.BRAMOVERHEAD);
    ...
    public static void main(String args[]){
        XilinxV7DeviceClassGenerator gen = new XilinxV7DeviceClassGenerator();
